...
app.get('/airkorea/detail', async (req, res) => {
    const serviceKey = "09ndL6cEw4ZiFubDUYiB7aGZP%2BW10%2BhR8vrNu3AfxEmW09DOLliES5u6786GARVL%2FiTXjz9MkoOmzw0iZn1VrQ%3D%3D";
    ...
    try {
        ...
        const airItem = {
            "location": "마포구", // 지역 result.data.ArpltnInforInqireSvcVo["stationName"]
            ...
            // "location": result.data.ArpltnInforInqireSvcVo["stationName"], // 지역 result.data.ArpltnInforInqireSvcVo["stationName"]
